...
app.get('/api/my-review/:MAKH', (req, res) => {
  const query = 'SELECT appointment.NGAYKHAM, appointment.KHUNGGIO, appointment.HOTEN, appointment.PHONE, service.TENDV, nhasi.TENNS, danhgia_bacsi.SOSAONS, danhgia_bacsi.BINHLUANNS, danhgia_dichvu.SOSAODV, danhgia_dichvu.BINHLUANDV FROM appointment JOIN danhgia_bacsi ON (danhgia_bacsi.MAKH = appointment.MAKH AND danhgia_bacsi.NGAYKHAM = appointment.NGAYKHAM) JOIN danhgia_dichvu ON (danhgia_dichvu.MAKH = appointment.MAKH AND danhgia_dichvu.NGAYKHAM = appointment.NGAYKHAM) JOIN service ON appointment.MADV = service.MADV JOIN nhasi ON appointment.MANS = nhasi.MANS WHERE appointment.MAKH = ?';
...
app.get('/api/my-review/:MAKH/:NGAYKHAM', (req, res) => {
  const query = 'SELECT appointment.NGAYKHAM, appointment.KHUNGGIO, appointment.HOTEN, appointment.PHONE, service.TENDV, nhasi.TENNS, danhgia_bacsi.SOSAONS, danhgia_bacsi.BINHLUANNS, danhgia_dichvu.SOSAODV, danhgia_dichvu.BINHLUANDV FROM appointment JOIN danhgia_bacsi ON (danhgia_bacsi.MAKH = appointment.MAKH AND danhgia_bacsi.NGAYKHAM = appointment.NGAYKHAM) JOIN danhgia_dichvu ON (danhgia_dichvu.MAKH = appointment.MAKH AND danhgia_dichvu.NGAYKHAM = appointment.NGAYKHAM) JOIN service ON appointment.MADV = service.MADV JOIN nhasi ON appointment.MANS = nhasi.MANS WHERE appointment.MAKH = ? AND appointment.NGAYKHAM=?';
  const { MAKH, NGAYKHAM } = req.params;
  db.query(query, [MAKH, NGAYKHAM], (err, results) => {
    if (err) {
      console.error('Error executing query:', err);
...
app.get('/api/unreviewed-appointment/:MAKH', (req, res) => {
  const query = 'SELECT appointment.NGAYKHAM, appointment.KHUNGGIO, appointment.HOTEN, appointment.PHONE, service.TENDV, nhasi.TENNS, danhgia_bacsi.SOSAONS, danhgia_bacsi.BINHLUANNS, danhgia_dichvu.SOSAODV, danhgia_dichvu.BINHLUANDV FROM appointment LEFT JOIN danhgia_bacsi ON danhgia_bacsi.MAKH = appointment.MAKH AND danhgia_bacsi.NGAYKHAM = appointment.NGAYKHAM LEFT JOIN danhgia_dichvu ON danhgia_dichvu.MAKH = appointment.MAKH AND danhgia_dichvu.NGAYKHAM = appointment.NGAYKHAM JOIN service ON appointment.MADV = service.MADV JOIN nhasi ON appointment.MANS = nhasi.MANS WHERE appointment.MAKH = ? AND (danhgia_bacsi.SOSAONS IS NULL OR danhgia_dichvu.SOSAODV IS NULL) AND appointment.NGAYKHAM < CURDATE()';
  const { MAKH } = req.params;
  db.query(query, [MAKH], (err, results) => {
    if (err) {
      console.error('Error executing query:', err);
