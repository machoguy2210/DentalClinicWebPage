...
<template>
  <div
    class="bg-blue-100 flex align-items-center justify-content-between px-8 py-2"
  >
    <!-- Logo -->
    ...
    <!-- Search -->
    <div
      class="p-input-icon-left ml-5 w-25rem align-items-center"
      style="height: 2.5rem"
    >
    ...
    <div class="flex gap-5">
      ...
      >
        <div class="flex align-items-center gap-2">
          <div
            style="width: 2.5rem; object-fit: cover"
            class="-mb-1 border-circle flex align-items-center"
          >
            <img
              src="../public/imagins/hour.png"
        ...
        >
          <div v-for="(menu, index) in menuUser" :key="index">
            <span
              class="cursor-pointer hover:text-blue-700 text-base lg:text-lg"
              >{{ menu.label }}</span
            >
