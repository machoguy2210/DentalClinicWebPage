<script setup></script>
<template>
    <div class="bg-black-alpha-10 mt-8">
        <div class="flex" style="gap: 30rem">
            ...
            <div class="flex flex-column" style="margin-right:20rem;">
                ...
                <div class="my-2"><a href="" class="text-color text-2xl no-underline">Giới thiệu Nha khoa Minh Thu</a></div>
                <div class="my-2"><a href="" class="text-color text-2xl no-underline">Đội ngũ bác sĩ</a></div>
                <div class="my-2"><a href="" class="text-color text-2xl no-underline">Cơ sở vật chất</a></div>
                <div class="my-2"><a href="" class="text-color text-2xl no-underline">Tin tức hoạt động</a></div>
            </div>
        </div>
    </div>
</template>
